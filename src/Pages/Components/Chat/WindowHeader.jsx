...
export const WindowHeader = ({handleClose,handleMaximize,handleMinimize,isCloseable,isMaximizable,isMinimizable}) => {
  return (
    //2D2733
    <div className='border border-black/20 border-b-black/70 rounded-t-xl px-4 py-4 flex window-header items-center' style={{background: '#2D2733'}}>
        ...
        <div className='h-full w-full flex justify-center gap-2 '>
           <p className='text-lg font-semibold'>AJUSTES</p>
