  ...
  return (
    <form id="loginForm" onSubmit={checkPassword}>
      <div className='w-100 h-max justify-center flex tinUpIn'>
        <img className='rounded-full bg-white w-[10rem] drop-shadow-lg border-[0.2rem] border-white hover:scale-110 transition-all' 
        src="https://wallpapers-clan.com/wp-content/uploads/2022/08/default-pfp-2.jpg" />
      </div>
